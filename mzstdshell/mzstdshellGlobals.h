...
#ifndef __MZSTDSHELL_GLOBALS_H__
#define __MZSTDSHELL_GLOBALS_H__

#ifndef __MZSTDSHELL_COMMON_H__
    #include "mzstdshellCommon.h"
#endif

DECLSPEC_MZSTDSHELL VOID WINAPI initMzstdshellLibrary();
DECLSPEC_MZSTDSHELL VOID WINAPI cleanupMzstdshellLibrary();
