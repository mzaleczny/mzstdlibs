...
#ifndef __MZSTDGUI_SCREEN_H__
#define __MZSTDGUI_SCREEN_H__

#include "mzstdguiCommon.h"
#include "mzObject.h"

class DECLSPEC_MZSTDGUI CScreen : public mzstd::CmzObject {
public:
    WINAPI CScreen();
    virtual WINAPI ~CScreen();
