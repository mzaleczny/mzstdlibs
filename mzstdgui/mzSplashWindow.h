...
#ifndef __MZSTDGUI_SPLASH_WINDOW_H__
#define __MZSTDGUI_SPLASH_WINDOW_H__
...
class DECLSPEC_MZSTDGUI CSplashWindow : public CStyledWindow {
public:
    WINAPI CSplashWindow(CApplication *app, CWindow* parentWindow, mzstd::CmzString name, mzstd::CmzString bitmapFileName, CWindowClass *wc = NULL, HWND hWnd = NULL);
    virtual WINAPI ~CSplashWindow();
...
typedef CSplashWindow* PSplashWindow;
